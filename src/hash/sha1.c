...
gpointer compute_sha1(gpointer user_data) {
    ...
    else if (g_utf8_strlen(gtk_entry_get_text(GTK_ENTRY (hash_var->hash_entry[2])), -1) == SHA1_DIGEST_SIZE*2)
        goto fine;
