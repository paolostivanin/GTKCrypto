...
GtkWidget *do_mainwin(GtkApplication *app, struct widget_t *Widget);
		  ...
		  gpointer data)
{
	...
	g_signal_connect(button[0], "clicked", G_CALLBACK (quit), app);
	g_signal_connect(button[1], "clicked", G_CALLBACK (quit), app);
